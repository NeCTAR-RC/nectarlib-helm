...
spec:
  ...
  template:
    ...
    spec:
      ...
      {{- else }}
      affinity:
        podAffinity: {{- include "nectarlib.affinities.pods" (dict "type" $service.podAffinityPreset "component" $apiName "context" $) | nindent 10 }}
        podAntiAffinity: {{- include "nectarlib.affinities.pods" (dict "type" $service.podAntiAffinityPreset "component" $apiName "context" $) | nindent 10 }}
